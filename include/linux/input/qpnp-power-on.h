...
extern void pmicwd_init(struct platform_device *pdev, struct qpnp_pon *pon, bool sys_reset);
extern void kpdpwr_init(struct qpnp_pon *pon,  bool sys_reset);
...
static inline bool is_pon_gen3(struct qpnp_pon *pon)
{
